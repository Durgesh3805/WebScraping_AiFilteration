...
from job_scraper.spiders.jobspresso import JobspressoSpider
# from ai_scraper.job_scraper.spiders.naukri_scraper import NaukriSpider
...
def run_all_spiders():
    ...
    process.crawl(JobspressoSpider)
