    ...
    <div className="w-full flex justify-center py-10 px-4">
      <div className="w-full max-w-6xl bg-gradient-to-r from-red-400 to-red-300 rounded-[50px] p-8 md:p-14 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex-1 text-white">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-stretch gap-4 mb-4">
            <input
              type="email"
              required
              placeholder="Enter your work email"
              className="px-4 py-3 rounded-lg text-gray-800 flex-1 bg-white shadow-md outline-none focus:outline-none focus:ring-0"
            />
            <button
              type="submit"
